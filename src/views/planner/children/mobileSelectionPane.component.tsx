...
export const MobileSelectionPaneComponent: React.FC<any> = ({ generateRoute, full = true }) => {
  ...
  return (
    ...
    >
      ...
      <Grid.Row style={{ paddingTop: 0, marginTop: 0 }}>
        <Grid.Column width={mobileWidth}>
          <Grid.Column style={{ padding: 0 }} width={mobileWidth}>
          ...
          {Object.keys(Types).map((type: Types) => {
            return (
              <Grid.Column style={{ padding: 0 }} width={mobileWidth} key={type}>
                <SectionComponent
        ...
        <Grid.Column width={mobileWidth} style={{ padding: 0 }}>
...
export default MobileSelectionPaneComponent;
