    ...
    : [
        ...
        },
        {
          ...
          render: () => (
            <Grid centered>
              <Grid.Column width={12}>
                <Table collapsing style={{ borderRadius: 0 }} structured celled striped>
                  <Table.Header>
                  ...
                  <Table.Body>
                    {character.attributes.map((attr, id) => (
                      <Table.Row key={id}>
                        ...
                        <Table.Cell>
                          {Weapons[ReverseWeaponsLookupKeyed[attr.mastery]].items.map(({ id }) => (
    ...
    <CharacterView>
      ...
      >
        <Grid style={{ backgroundImage: BG_HALF }}>
          ...
          <Grid.Row style={{ backgroundColor: "rgba(255, 250, 250, 0.9)", paddingTop: 0 }} centered>
